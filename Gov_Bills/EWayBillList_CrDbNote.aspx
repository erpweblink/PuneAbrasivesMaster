<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/WLSPLMaster.master" AutoEventWireup="true" CodeFile="EWayBillList_CrDbNote.aspx.cs" Inherits="Gov_Bills_EWayBillList_CrDbNote" %>
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-9 col-md-10">
                    <h4 class="mt-4 ">&nbsp <b>E-WAY BILL LIST(Credit/Debit Note)</b></h4>
                </div>
                <div class="col-md-2 mt-4">
                    <asp:Button ID="btneinvoicelist" CssClass="form-control btn btn-warning" Font-Bold="true" Text="E-Invoice List" CausesValidation="false" runat="server" OnClick="btneinvoicelist_Click" />
