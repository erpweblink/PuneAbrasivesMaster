...
public partial class Gov_Bills_EWayBillList_CrDbNote : System.Web.UI.Page
{
    ...
    protected void GVBinddata()
    {
        try
        {
            ...
            SqlDataAdapter sad = new SqlDataAdapter("select TOP 15 * from tblCreditDebitNoteHdr where isdeleted=0 and Status<>'' order by CreatedOn DESC", con);
            sad.Fill(dt);
    ...
    protected void btneinvoicelist_Click(object sender, EventArgs e)
    {
