<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/WLSPLMaster.master" AutoEventWireup="true" CodeFile="InwardEntry.aspx.cs" Inherits="Admin_InwardEntry" %>
                                            ...
                                            <table class="table text-center align-middle table-bordered table-hover" border="1" style="width: 100%; border: 1px solid #0c7d38;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtComQuantity" Width="190px" Text="0" CssClass="form-control" OnTextChanged="txtComQuantity_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <thead>
