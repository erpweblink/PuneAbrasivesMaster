<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/WLSPLMaster.master" AutoEventWireup="true" CodeFile="ComponentList.aspx.cs" Inherits="Admin_ComponentList" %>
            ...
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-9 col-md-10">
                        <h4 class="mt-4 ">&nbsp <b>COMPONENT LIST</b></h4>
                    </div>
                        ...
                        <div class="table ">
                            <asp:GridView ID="GVComponentlist" runat="server" CellPadding="4" DataKeyNames="id" PageSize="10" AllowPaging="true" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Component Code" HeaderStyle-CssClass="gvhead">
                                        <ItemTemplate>
