<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/WLSPLMaster.master" AutoEventWireup="true" CodeFile="StoreInwardList.aspx.cs" Inherits="Admin_StoreInwardList" %>
    ...
    <script>
        ...
        function HideLabel(msg) {
            ...
            Swal.fire({
                ...
                window.location.href = "../Inventory/StoreInwardList.aspx";
            })
        };
    </script>
            ...
            <div class="container-fluid px-4">
                <div class="row">
                    <div class="col-9 col-md-10">
                        <h4 class="mt-4 "><b>PENDING INWARD ENTRY LIST</b></h4>
                    </div>
                    <br />
                ...
                <div>
                    <div class="row">
                        ...
                        <div style="overflow-x: auto; max-height: 600px; overflow-y: auto; border: 1px solid #ccc;">
                            <asp:GridView ID="GVInward" runat="server" CellPadding="4" DataKeyNames="ID" Width="100%" PageSize="10" AllowPaging="true"
